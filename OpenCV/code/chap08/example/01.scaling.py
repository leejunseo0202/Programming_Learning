...
if image is None : raise Exception("이미지 불러오기 오류")

dst1 = scaling(image, (150, 200))
dst2 = scaling(image, (150, 200))
dst3 = time_check(scaling, image, (300, 400), "방법1")
dst4 = time_check(scaling2, image, (300, 400), "방법2")
