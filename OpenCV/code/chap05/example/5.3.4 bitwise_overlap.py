...
image=cv2.imread("c:/computervision/chap05/image/img.jpg", cv2.IMREAD_COLOR)
image=image[100:900,:500]
logo=cv2.imread("c:/computervision/chap05/image/opencv_logo.png", cv2.IMREAD_COLOR)
if image is None or logo is None: raise Exception("영상 입력 오류")
